...
//                        .authenticated()
                        ...
                        .requestMatchers(antMatcher("/categories/create/**")).hasRole("ADMIN")
                        .requestMatchers(antMatcher("/categories/update")).hasRole("ADMIN")
                        .requestMatchers(antMatcher("/categories/delete/**")).hasRole("ADMIN")
                        .requestMatchers(antMatcher( "/images/create/*")).hasRole("ADMIN")
                        .requestMatchers(antMatcher( "/images/delete/*")).hasRole("ADMIN")
